...
You can read more about security and risks in [SECURITY.md](./SECURITY.md) and in the [Axia Wiki](https://wiki.polkaaxc.network/docs/learn-account-generation).
...
You can read more about the SS58 format in the [Axlib Docs](https://docs.axlib.io/v3/advanced/ss58/) and see the list of reserved prefixes in the [SS58 Registry](https://github.com/axiatech/ss58-registry).
...
```bash
subkey vanity --network polkaaxc --pattern bob
```
