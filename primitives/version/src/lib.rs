...
pub struct RuntimeVersion {
	/// Identifies the different Axlib runtimes. There'll be at least polkaaxc and node.
	...
	/// codebase, it will be axia-polkaaxc. If there were a non-Rust implementation of the
