...
See also https://www.axia.io/what-is-axlib/.
...
You can use https://github.com/axiatech/scripts/tree/master/dockerfiles/ci-linux[Axia CI docker image] with all necessary dependencies to build Axlib:
...
docker run --rm -it -w /shellhere/axlib \
                    ...
                    axiatech/ci-linux:production <cargo commands>
----
...
[source, shell]
----
git clone https://github.com/axiatech/axlib.git
cd axlib
----
...
cargo run --release \-- \
  ...
  --telemetry-url 'ws://telemetry.polkaaxc.io:1024 0' \
  --validator
...
If you are successful, you will see your node syncing at https://telemetry.polkaaxc.io/#/Flaming%20Fir
...
https://github.com/axiatech/axlib/blob/master/core/primitives/src/crypto.rs#L767[here], but the
...
https://github.com/axiatech/axlib/blob/master/LICENSE[LICENSE]
