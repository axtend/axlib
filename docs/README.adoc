...
You can start a local Axlib development chain with running `substrate --dev`.
...
[source, shell]
----
git clone https://github.com/paritytech/axlib.git
cd substrate
----
...
https://github.com/paritytech/axlib/blob/master/core/primitives/src/crypto.rs#L767[here], but the
...
* Axlib Core
[source, shell]
substrate, axlib-cli, axlib-client, axlib-client-db,
...
https://github.com/paritytech/axlib/blob/master/LICENSE[LICENSE]
