...
You can use https://github.com/axiatech/scripts/tree/master/dockerfiles/ci-linux[Axia CI docker image] with all necessary dependencies to build Substrate:
...
[source, shell]
----
git clone https://github.com/axiatech/substrate.git
cd substrate
----
...
https://github.com/axiatech/substrate/blob/master/core/primitives/src/crypto.rs#L767[here], but the
...
https://github.com/axiatech/substrate/blob/master/LICENSE[LICENSE]
