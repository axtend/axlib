...
cargo run --release \-- \
  ...
  --telemetry-url 'ws://telemetry.axiacoin.network:1024 0' \
  --validator
...
If you are successful, you will see your node syncing at https://telemetry.axiacoin.network/#/Flaming%20Fir
