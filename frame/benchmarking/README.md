# Axlib Runtime Benchmarking Framework

This crate contains a set of utilities that can be used to benchmark and weigh FRAME pallets that
you develop for your Axlib Runtime.

## Overview

Axlib's FRAME framework allows you to develop custom logic for your blockchain that can be
...
The Axlib Runtime Benchmarking Framework is a tool you can use to mitigate DoS attacks against
...
Axlib represents computational resources using a generic unit of measurement called "Weight". It
...
Examples of end-to-end benchmarks can be found in the [pallets provided by Axlib](../), and the
...
need to move into your node's binary folder. For example, with the Axlib repository, this is how
...
> NOTE: Axlib uses a virtual workspace which does not allow you to compile with feature flags.
> ```
...
see an example of how to do this in the [included Axlib
...
Axlib pallets while still keeping your network safe for your specific configuration and
requirements.
